...
if __name__ == '__main__':
    loss = MCSoftContrastiveLoss()
    modality1_embed_dict ={}
    modality1_embed_dict['mean'] = torch.randn(5,1024)
    modality1_embed_dict['std'] = torch.randn(5,1024)
    
    modality2_embed_dict ={}
    modality2_embed_dict['mean'] = torch.randn(5,1024)
    modality2_embed_dict['std'] = torch.randn(5,1024)

    print(loss(modality1_embed_dict, modality2_embed_dict))